...
echo "=================================="
echo "Phase 1: dotnet-sdk-10-0 Image Tests"
echo "=================================="
echo ""
...
if echo "$VERSION_OUTPUT" | grep -q "10\.0"; then
    echo "✓ PASSED - .NET SDK 10.0 detected"
else
    echo "✗ FAILED - Expected .NET SDK 10.0"
    echo "$VERSION_OUTPUT"
    exit 1
fi
echo ""
...
if echo "$SDKS_OUTPUT" | grep -q "10\.0"; then
    echo "✓ PASSED - .NET SDK 10.0 listed"
else
    echo "✗ FAILED - .NET SDK 10.0 not found in list"
    exit 1
fi
echo ""
...
echo "=================================="
echo "All dotnet-sdk-10-0 tests PASSED!"
echo "=================================="
