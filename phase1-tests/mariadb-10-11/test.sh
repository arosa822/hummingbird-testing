...
echo "=================================="
echo "Phase 1: mariadb-10-11 Image Tests"
echo "=================================="
echo ""
...
if echo "$VERSION_OUTPUT" | grep -qi "10.11\|MariaDB"; then
    echo "✓ PASSED - MariaDB 10.11 detected"
else
...
echo "=================================="
echo "All mariadb-10-11 tests PASSED!"
echo "=================================="
