...
echo "=================================="
echo "Phase 1: openjdk-25 Image Tests"
echo "=================================="
echo ""

# Test 1: Verify Java version
echo "[TEST 1] Verify OpenJDK 25 version"
...
if echo "$VERSION_OUTPUT" | grep -q "25"; then
    echo "✓ PASSED - OpenJDK 25 detected"
else
    echo "✗ FAILED - Expected OpenJDK 25"
    exit 1
fi
echo ""
...
if [[ "$JAVAC_OUTPUT" == *"25"* ]]; then
    echo "✓ PASSED - javac 25 detected"
else
...
echo "=================================="
echo "All openjdk-25 tests PASSED!"
echo "=================================="
