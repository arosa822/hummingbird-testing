...
## Image Information
- **Image Name:** nginx
- **Registry:** quay.io/hummingbird/nginx
- **Variants:** 
...
## Primary Utility
nginx command for serving web traffic and reverse proxy
...
### Pull and Inspect
```bash
podman pull quay.io/hummingbird/nginx:latest
podman inspect quay.io/hummingbird/nginx:latest
```
...
### Security Scan
```bash
./ci/grype-hummingbird.sh quay.io/hummingbird/nginx:latest
```
