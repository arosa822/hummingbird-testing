...
echo "=================================="
echo "Phase 1: python-3-11 Image Tests"
echo "=================================="
echo ""

# Test 1: Verify Python version
echo "[TEST 1] Verify Python 3.11 version"
...
if [[ "$VERSION_OUTPUT" == *"Python 3.11"* ]]; then
    echo "✓ PASSED - Python 3.11 detected"
else
    echo "✗ FAILED - Expected Python 3.11, got ${VERSION_OUTPUT}"
    exit 1
fi
echo ""
...
echo "=================================="
echo "All python-3-11 tests PASSED!"
echo "=================================="
