...
echo "=================================="
echo "Phase 1: ruby-4-0 Image Tests"
echo "=================================="
echo ""

# Test 1: Verify Ruby version
echo "[TEST 1] Verify Ruby 4.0 version"
echo "Command: ${TEST_ENGINE} run --rm ${IMAGE} ruby --version"
VERSION_OUTPUT=$(${TEST_ENGINE} run --rm ${IMAGE} ruby --version)
echo "Output: ${VERSION_OUTPUT}"
if [[ "$VERSION_OUTPUT" == *"ruby 4.0"* ]]; then
    echo "✓ PASSED - Ruby 4.0 detected"
else
    echo "✗ FAILED - Expected Ruby 4.0, got ${VERSION_OUTPUT}"
    exit 1
fi
echo ""
...
echo "=================================="
echo "All ruby-4-0 tests PASSED!"
echo "=================================="
