...
echo "=================================="
echo "Phase 1: aspnet-runtime-8-0 Image Tests"
echo "=================================="
echo ""
...
if echo "$VERSION_OUTPUT" | grep -q "8\.0"; then
    echo "✓ PASSED - ASP.NET 8.0 runtime detected"
else
    echo "✗ FAILED - Expected ASP.NET 8.0"
    echo "$VERSION_OUTPUT"
    exit 1
fi
echo ""
...
echo "=================================="
echo "All aspnet-runtime-8-0 tests PASSED!"
echo "=================================="
