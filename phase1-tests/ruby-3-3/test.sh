...
echo "=================================="
echo "Phase 1: ruby-3-3 Image Tests"
echo "=================================="
echo ""

# Test 1: Verify Ruby version
echo "[TEST 1] Verify Ruby 3.3 version"
echo "Command: ${TEST_ENGINE} run --rm ${IMAGE} ruby --version"
VERSION_OUTPUT=$(${TEST_ENGINE} run --rm ${IMAGE} ruby --version)
echo "Output: ${VERSION_OUTPUT}"
if [[ "$VERSION_OUTPUT" == *"ruby 3.3"* ]]; then
    echo "✓ PASSED - Ruby 3.3 detected"
else
    echo "✗ FAILED - Expected Ruby 3.3, got ${VERSION_OUTPUT}"
    exit 1
fi
echo ""
...
echo "=================================="
echo "All ruby-3-3 tests PASSED!"
echo "=================================="
