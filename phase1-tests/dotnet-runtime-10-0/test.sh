...
echo "=================================="
echo "Phase 1: dotnet-runtime-10-0 Image Tests"
echo "=================================="
echo ""
...
if echo "$VERSION_OUTPUT" | grep -q "10\.0"; then
    echo "✓ PASSED - .NET 10.0 runtime detected"
else
    echo "✗ FAILED - Expected .NET 10.0"
    echo "$VERSION_OUTPUT"
    exit 1
fi
echo ""
...
echo "=================================="
echo "All dotnet-runtime-10-0 tests PASSED!"
echo "=================================="
