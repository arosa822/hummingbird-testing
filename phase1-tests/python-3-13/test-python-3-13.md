# Test Plan: python-3-13

## Image Information
- **Image Name:** python-3-13
- **Registry:** quay.io/hummingbird/python-3-13
- **Variants:** 
  - `latest` - Default distroless variant
  - `latest-builder` - Builder variant with package manager

## Description
Python 3.13 interpreter for running Python applications and scripts.
...
### Pull and Inspect
```bash
podman pull quay.io/hummingbird/python-3-13:latest
podman inspect quay.io/hummingbird/python-3-13:latest
```
...
### Security Scan
```bash
./ci/grype-hummingbird.sh quay.io/hummingbird/python-3-13:latest
```
