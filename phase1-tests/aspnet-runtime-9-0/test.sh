...
echo "=================================="
echo "Phase 1: aspnet-runtime-9-0 Image Tests"
echo "=================================="
echo ""
...
if echo "$VERSION_OUTPUT" | grep -q "9\.0"; then
    echo "✓ PASSED - ASP.NET 9.0 runtime detected"
else
    echo "✗ FAILED - Expected ASP.NET 9.0"
    echo "$VERSION_OUTPUT"
    exit 1
fi
echo ""
...
echo "=================================="
echo "All aspnet-runtime-9-0 tests PASSED!"
echo "=================================="
