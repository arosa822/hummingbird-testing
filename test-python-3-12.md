# Test Plan: python-3-12

## Image Information
- **Image Name:** python-3-12
- **Registry:** quay.io/hummingbird/python-3-12
- **Variants:** 
  - `latest` - Default distroless variant
  - `latest-builder` - Builder variant with package manager

## Description
Python 3.12 interpreter for running Python applications and scripts.

## Primary Utility
python3 command for executing Python code
...
### Pull and Inspect
```bash
podman pull quay.io/hummingbird/python-3-12:latest
podman inspect quay.io/hummingbird/python-3-12:latest
```
...
### Security Scan
```bash
./ci/grype-hummingbird.sh quay.io/hummingbird/python-3-12:latest
```
