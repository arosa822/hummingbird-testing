# Test Plan: python-3-14

## Image Information
- **Image Name:** python-3-14
- **Registry:** quay.io/hummingbird/python-3-14
- **Variants:** 
  - `latest` - Default distroless variant
  - `latest-builder` - Builder variant with package manager

## Description
Python 3.14 interpreter for running Python applications and scripts.
...
### Pull and Inspect
```bash
podman pull quay.io/hummingbird/python-3-14:latest
podman inspect quay.io/hummingbird/python-3-14:latest
```
...
### Security Scan
```bash
./ci/grype-hummingbird.sh quay.io/hummingbird/python-3-14:latest
```
