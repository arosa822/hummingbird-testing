# Test Plan: aspnet-runtime-10-0

## Image Information
- **Image Name:** aspnet-runtime-10-0
- **Registry:** quay.io/hummingbird/aspnet-runtime-10-0
- **Variants:** 
  - `latest` - Default distroless variant
  - `latest-builder` - Builder variant with package manager

## Description
ASP.NET Core 10.0 runtime for hosting ASP.NET web applications and APIs.
...
### Pull and Inspect
```bash
podman pull quay.io/hummingbird/aspnet-runtime-10-0:latest
podman inspect quay.io/hummingbird/aspnet-runtime-10-0:latest
```
...
### Security Scan
```bash
./ci/grype-hummingbird.sh quay.io/hummingbird/aspnet-runtime-10-0:latest
```
