# Test Plan: python-3-11

## Image Information
- **Image Name:** python-3-11
- **Registry:** quay.io/hummingbird/python-3-11
- **Variants:** 
  - `latest` - Default distroless variant
  - `latest-builder` - Builder variant with package manager

## Description
Python 3.11 interpreter for running Python applications and scripts.
...
### Pull and Inspect
```bash
podman pull quay.io/hummingbird/python-3-11:latest
podman inspect quay.io/hummingbird/python-3-11:latest
```
...
### Security Scan
```bash
./ci/grype-hummingbird.sh quay.io/hummingbird/python-3-11:latest
```
