...
## Image Information
- **Image Name:** ruby-3-3
- **Registry:** quay.io/hummingbird/ruby-3-3
- **Variants:** 
  - `latest` - Default distroless variant
  - `latest-builder` - Builder variant with package manager

## Description
Ruby 3.3 programming language interpreter for running Ruby applications and scripts.
...
### Pull and Inspect
```bash
podman pull quay.io/hummingbird/ruby-3-3:latest
podman inspect quay.io/hummingbird/ruby-3-3:latest
```
...
### Security Scan
```bash
./ci/grype-hummingbird.sh quay.io/hummingbird/ruby-3-3:latest
```
