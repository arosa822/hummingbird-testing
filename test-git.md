...
## Image Information
- **Image Name:** git
- **Registry:** quay.io/hummingbird/git
- **Variants:** 
...
### Pull and Inspect
```bash
podman pull quay.io/hummingbird/git:latest
podman inspect quay.io/hummingbird/git:latest
```
...
### Security Scan
```bash
./ci/grype-hummingbird.sh quay.io/hummingbird/git:latest
```
