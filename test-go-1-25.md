...
## Image Information
- **Image Name:** go-1-25
- **Registry:** quay.io/hummingbird/go-1-25
- **Variants:** 
  - `latest` - Default distroless variant
  - `latest-builder` - Builder variant with package manager

## Description
Go 1.25 programming language compiler and toolchain for building Go applications.

## Primary Utility
go build command for compiling Go programs
...
### Pull and Inspect
```bash
podman pull quay.io/hummingbird/go-1-25:latest
podman inspect quay.io/hummingbird/go-1-25:latest
```
...
### Security Scan
```bash
./ci/grype-hummingbird.sh quay.io/hummingbird/go-1-25:latest
```
