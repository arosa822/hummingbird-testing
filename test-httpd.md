...
## Image Information
- **Image Name:** httpd
- **Registry:** quay.io/hummingbird/httpd
- **Variants:** 
...
## Primary Utility
httpd command for serving HTTP traffic
...
### Pull and Inspect
```bash
podman pull quay.io/hummingbird/httpd:latest
podman inspect quay.io/hummingbird/httpd:latest
```
...
### Security Scan
```bash
./ci/grype-hummingbird.sh quay.io/hummingbird/httpd:latest
```
