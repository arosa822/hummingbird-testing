# Test Plan: dotnet-sdk-9-0

## Image Information
- **Image Name:** dotnet-sdk-9-0
- **Registry:** quay.io/hummingbird/dotnet-sdk-9-0
- **Variants:** 
  - `latest` - Default distroless variant
  - `latest-builder` - Builder variant with package manager

## Description
.NET SDK 9.0 for building, testing, and publishing .NET applications.
...
### Pull and Inspect
```bash
podman pull quay.io/hummingbird/dotnet-sdk-9-0:latest
podman inspect quay.io/hummingbird/dotnet-sdk-9-0:latest
```
...
### Security Scan
```bash
./ci/grype-hummingbird.sh quay.io/hummingbird/dotnet-sdk-9-0:latest
```
