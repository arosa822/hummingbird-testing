# Test Plan: dotnet-runtime-10-0

## Image Information
- **Image Name:** dotnet-runtime-10-0
- **Registry:** quay.io/hummingbird/dotnet-runtime-10-0
- **Variants:** 
  - `latest` - Default distroless variant
  - `latest-builder` - Builder variant with package manager

## Description
.NET 10.0 runtime for running .NET console applications and libraries.

## Primary Utility
dotnet command for running .NET applications
...
### Pull and Inspect
```bash
podman pull quay.io/hummingbird/dotnet-runtime-10-0:latest
podman inspect quay.io/hummingbird/dotnet-runtime-10-0:latest
```
...
### Security Scan
```bash
./ci/grype-hummingbird.sh quay.io/hummingbird/dotnet-runtime-10-0:latest
```
