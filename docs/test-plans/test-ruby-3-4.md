...
## Image Information
- **Image Name:** ruby-3-4
- **Registry:** quay.io/hummingbird/ruby-3-4
- **Variants:** 
  - `latest` - Default distroless variant
  - `latest-builder` - Builder variant with package manager

## Description
Ruby 3.4 programming language interpreter for running Ruby applications and scripts.
...
### Pull and Inspect
```bash
podman pull quay.io/hummingbird/ruby-3-4:latest
podman inspect quay.io/hummingbird/ruby-3-4:latest
```
...
### Security Scan
```bash
./ci/grype-hummingbird.sh quay.io/hummingbird/ruby-3-4:latest
```
