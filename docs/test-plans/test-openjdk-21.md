# Test Plan: openjdk-21

## Image Information
- **Image Name:** openjdk-21
- **Registry:** quay.io/hummingbird/openjdk-21
- **Variants:** 
  - `latest` - Default distroless variant
  - `latest-builder` - Builder variant with package manager

## Description
OpenJDK 21 Java Development Kit for running and building Java applications.

## Primary Utility
java command for running JVM applications
...
### Pull and Inspect
```bash
podman pull quay.io/hummingbird/openjdk-21:latest
podman inspect quay.io/hummingbird/openjdk-21:latest
```
...
### Security Scan
```bash
./ci/grype-hummingbird.sh quay.io/hummingbird/openjdk-21:latest
```
