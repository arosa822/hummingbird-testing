...
## Image Information
- **Image Name:** tomcat-11
- **Registry:** quay.io/hummingbird/tomcat-11
- **Variants:** 
  - `latest` - Default distroless variant
  - `latest-builder` - Builder variant with package manager

## Description
Apache Tomcat 11 Java Servlet container for deploying Java web applications and servlets.
...
### Pull and Inspect
```bash
podman pull quay.io/hummingbird/tomcat-11:latest
podman inspect quay.io/hummingbird/tomcat-11:latest
```
...
### Security Scan
```bash
./ci/grype-hummingbird.sh quay.io/hummingbird/tomcat-11:latest
```
