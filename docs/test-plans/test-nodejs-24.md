...
## Image Information
- **Image Name:** nodejs-24
- **Registry:** quay.io/hummingbird/nodejs-24
- **Variants:** 
  - `latest` - Default distroless variant
  - `latest-builder` - Builder variant with package manager

## Description
Node.js 24 JavaScript runtime for executing server-side JavaScript applications.
...
### Pull and Inspect
```bash
podman pull quay.io/hummingbird/nodejs-24:latest
podman inspect quay.io/hummingbird/nodejs-24:latest
```
...
### Security Scan
```bash
./ci/grype-hummingbird.sh quay.io/hummingbird/nodejs-24:latest
```
