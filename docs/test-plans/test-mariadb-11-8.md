# Test Plan: mariadb-11-8

## Image Information
- **Image Name:** mariadb-11-8
- **Registry:** quay.io/hummingbird/mariadb-11-8
- **Variants:** 
  - `latest` - Default distroless variant
  - `latest-builder` - Builder variant with package manager

## Description
MariaDB 11.8 relational database server, MySQL-compatible open-source database.
...
### Pull and Inspect
```bash
podman pull quay.io/hummingbird/mariadb-11-8:latest
podman inspect quay.io/hummingbird/mariadb-11-8:latest
```
...
### Security Scan
```bash
./ci/grype-hummingbird.sh quay.io/hummingbird/mariadb-11-8:latest
```
