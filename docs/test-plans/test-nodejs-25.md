...
## Image Information
- **Image Name:** nodejs-25
- **Registry:** quay.io/hummingbird/nodejs-25
- **Variants:** 
  - `latest` - Default distroless variant
  - `latest-builder` - Builder variant with package manager

## Description
Node.js 25 JavaScript runtime for executing server-side JavaScript applications.
...
### Pull and Inspect
```bash
podman pull quay.io/hummingbird/nodejs-25:latest
podman inspect quay.io/hummingbird/nodejs-25:latest
```
...
### Security Scan
```bash
./ci/grype-hummingbird.sh quay.io/hummingbird/nodejs-25:latest
```
