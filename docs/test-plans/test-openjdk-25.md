# Test Plan: openjdk-25

## Image Information
- **Image Name:** openjdk-25
- **Registry:** quay.io/hummingbird/openjdk-25
- **Variants:** 
  - `latest` - Default distroless variant
  - `latest-builder` - Builder variant with package manager

## Description
OpenJDK 25 Java Development Kit for running and building Java applications.
...
### Pull and Inspect
```bash
podman pull quay.io/hummingbird/openjdk-25:latest
podman inspect quay.io/hummingbird/openjdk-25:latest
```
...
### Security Scan
```bash
./ci/grype-hummingbird.sh quay.io/hummingbird/openjdk-25:latest
```
