# Test Plan: dotnet-runtime-9-0

## Image Information
- **Image Name:** dotnet-runtime-9-0
- **Registry:** quay.io/hummingbird/dotnet-runtime-9-0
- **Variants:** 
  - `latest` - Default distroless variant
  - `latest-builder` - Builder variant with package manager

## Description
.NET 9.0 runtime for running .NET console applications and libraries.
...
### Pull and Inspect
```bash
podman pull quay.io/hummingbird/dotnet-runtime-9-0:latest
podman inspect quay.io/hummingbird/dotnet-runtime-9-0:latest
```
...
### Security Scan
```bash
./ci/grype-hummingbird.sh quay.io/hummingbird/dotnet-runtime-9-0:latest
```
