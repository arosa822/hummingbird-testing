...
## Image Information
- **Image Name:** go-1-26
- **Registry:** quay.io/hummingbird/go-1-26
- **Variants:** 
  - `latest` - Default distroless variant
  - `latest-builder` - Builder variant with package manager

## Description
Go 1.26 programming language compiler and toolchain for building Go applications.
...
### Pull and Inspect
```bash
podman pull quay.io/hummingbird/go-1-26:latest
podman inspect quay.io/hummingbird/go-1-26:latest
```
...
### Security Scan
```bash
./ci/grype-hummingbird.sh quay.io/hummingbird/go-1-26:latest
```
