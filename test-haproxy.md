...
## Image Information
- **Image Name:** haproxy
- **Registry:** quay.io/hummingbird/haproxy
- **Variants:** 
...
### Pull and Inspect
```bash
podman pull quay.io/hummingbird/haproxy:latest
podman inspect quay.io/hummingbird/haproxy:latest
```
...
### Security Scan
```bash
./ci/grype-hummingbird.sh quay.io/hummingbird/haproxy:latest
```
